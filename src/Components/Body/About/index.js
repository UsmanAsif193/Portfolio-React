...
function About() {
  ...
  let aboutCodingLight =
    "https://usmanasif961507868.files.wordpress.com/2021/08/coding-light.png";
  let aboutCodingDark =
    "https://usmanasif961507868.files.wordpress.com/2021/08/coding-dark.png";
  return (
    <div className="about">
